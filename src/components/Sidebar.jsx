...
export const Sidebar = ({
  ...
  return (
    <div
      ...
      } bg-gray-900 text-white transition-all duration-300 overflow-hidden flex flex-col h-full`}
    >
      ...
      <div className="flex-1 overflow-y-auto py-2">
        ...
        {groupedConversations.yesterday.length > 0 && (
          <>
            <div className="px-3 py-1 text-xs font-medium text-gray-400 uppercase mt-3">
              Yesterday
            </div>
